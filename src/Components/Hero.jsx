...
const Hero = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-5 bg-light text-center ">
      ...
      <form className="flex flex-col md:flex-row items-start md:items-centar justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,00.1)]">
      ...
      <img src={assets.main_car} alt="car" className="h-60 w-200 m-10" />
    </div>
  );
};
